...
<div class="message-container">
    <a href="Message.php?username=<?php echo $username; ?>&profile_pic=<?php echo $_SESSION['profile_picture']; ?>&name=<?php echo $name; ?>" class="message-btn">Message</a>
</div>
                 ...
                 if ($viewsearchres && $viewsearchres->num_rows > 0){
                    while ($row = $viewsearchres->fetch_assoc()){
                      ...
                      echo "<div class='post-info'>";
                        ...
                        echo "<button type='submit' name='BTN_LIKE' class='like' id='likeBtn{$row["post_id"]}' onclick='likePost({$row["post_id"]})'><img src='../assets/css/icons8-love-24.png' alt=''></button>";
                        echo "</form>";
